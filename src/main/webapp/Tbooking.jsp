...
%>
 ...
 <!-- ************************************************* -->
    <h2 class="title text-center">TRAVELERS BOOKING</h2>
    <form action="travelerbook"  method="post">
      ...
      <div class="form-control ">
       <div class="col-md-12 " >
        ...
        <span class="lighting"></span>
         ...
         <label >P_PLACE</label>
        <input class="form-control" name="P_PLACE"  id="P_PLACE" type="text" >
        <p id="emailp"></p>
        <span class="lighting"></span>
        
 
        <label >TO_PLACE</label>
        <input class="form-control" name="TO_PLACE"  id="TO_PLACE" type="text" >
        <p id="emailp"></p>
        <span class="lighting"></span>
